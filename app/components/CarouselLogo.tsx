...
const logosImages = [
    ...
    { src: "/ong/motivation.png", alt: "Company 3", href: "https://company3.com" },
    { src: "/ong/o-mana-de-ajutor.png", alt: "Company 3", href: "https://company3.com" },
    { src: "/ong/vocea-copiilor-abandonati.png", alt: "Company 3", href: "https://company3.com" },
]
...
export const CarouselLogo = React.memo<LogoLoopProps>(
    ({
         logos = logosImages,
         speed = 120,
         direction = 'left',
...
CarouselLogo.displayName = 'LogoLoop';
