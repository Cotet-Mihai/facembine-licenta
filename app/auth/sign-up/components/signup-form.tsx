  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <Field>
                ...
                />
                <FieldDescription>
                    Nu vom partaja adresa dvs. de e-mail cu nimeni altcineva.
                </FieldDescription>
              </Field>
              <Field>
              ...
              <FieldDescription className="text-center">
                  Ai deja un cont? <Link href="/auth/sign-in">Conectare</Link>
              </FieldDescription>
            </FieldGroup>
          </form>
        ...
        {/*TODO: Nu uita de termeni si conditii sa le faci*/}
      <FieldDescription className="px-6 text-center">
          Dând clic pe Continuă, sunteți de acord cu <a href="#">Termeni și condiții</a>{" "}
